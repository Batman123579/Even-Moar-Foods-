...
public class DeepFryer extends BlockContainer
{
    /**
    ...
    {
        return mod_MainClass.DeepFryerIdle.blockID;
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            TileEntityDeepFryer tileentitydeepfryer = (TileEntityDeepFryer)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, mod_MainClass.DeepFryerBurning.blockID);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, mod_MainClass.DeepFryerIdle.blockID);
        }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        if (!keepFurnaceInventory)
        {
            ...
            if (tileentitydeepfryer != null)
            {
                for (int j1 = 0; j1 < tileentitydeepfryer.getSizeInventory(); ++j1)
                {
                    ItemStack itemstack = tileentitydeepfryer.getStackInSlot(j1);
