...
public class TileEntityDeepFryer extends TileEntity implements ISidedInventory, net.minecraftforge.common.ISidedInventory
{
    ...
    {
        return this.isInvNameLocalized() ? this.field_94130_e : "Deep Fat Fryer";
    }
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        if (par1NBTTagCompound.hasKey("Deep Fat Fryer"))
        {
            this.field_94130_e = par1NBTTagCompound.getString("Deep Fat Fryer");
        }
    }
    ...
    public void writeToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            par1NBTTagCompound.setString("Deep Fat Fryer", this.field_94130_e);
        }
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                DeepFryer.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
