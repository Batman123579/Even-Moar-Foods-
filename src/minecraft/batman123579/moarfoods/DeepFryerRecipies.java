...
public class DeepFryerRecipies
{
    private static final DeepFryerRecipies smeltingBase = new DeepFryerRecipies();
     ...
     */
    public static final DeepFryerRecipies smelting()
    {
        return smeltingBase;
    }

    private DeepFryerRecipies()
    {
